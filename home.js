...
sr.reveal('.container-right', { delay: 200, origin: 'right' });
sr.reveal('h1', { delay: 200, origin: 'top' });
sr.reveal('p', { delay: 200, origin: 'left' });
sr.reveal('.btnn', { delay: 200, origin: 'left' });
sr.reveal('.down-arrow', { delay: 200, origin: 'top' });
sr.reveal('.header', { delay: 200, origin: 'top', reset: false });
sr.reveal('.footer', { delay: 200, origin: 'top' });


// ScrollReveal().reveal('#container10', {delay:200, origin: 'top',duration: 2600, reset:true, distance: '65px'})
